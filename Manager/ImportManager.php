...
class ImportManager
{
    ...
    const ATTRIBUTE_GROUP_VALIDATION_JOB = 'synolia_oroneo_attribute_group_import_validation_from_csv';
    const ATTRIBUTE_GROUP_JOB            = 'synolia_oroneo_attribute_group_import_from_csv';
